...
class Receivedone extends StatelessWidget {
  const Receivedone({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(Recievedonecontroller());
    // TODO: implement build
    return GetBuilder<Recievedonecontroller>(
        builder: (controller) => Handlingdataview(
            ...
            widget: Scaffold(
              ...
              child: ListView.builder(
                itemCount: controller.data3.length,
                itemBuilder: (context, index) {
                  return Details(controller.data3[index]);
                },
              ),
            ))));
  }
...
class Details extends GetView<Recievedonecontroller> {
